...
//    GtkWidget*shape=gtk_button_new_with_label("shape");
    GtkWidget*shape=sc_image_button_new_by_size(icon_shape_circle,20);
...
//    GtkWidget*arrow=gtk_button_new_with_label("arrow");
    GtkWidget*arrow=sc_image_button_new_by_size(icon_arrow,20);
...
//    GtkWidget*painter=gtk_button_new_with_label("painter");
    GtkWidget*painter=sc_image_button_new_by_size(icon_painter,20);
...
//    GtkWidget*text=gtk_button_new_with_label("text");
    GtkWidget*text=sc_image_button_new_by_size(icon_text,20);
